...
private Connection conn=null;
   ...
   {     
      ...
      PreparedStatement ps=conn.prepareStatement("select name,available from user order by name");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        System.out.println(model.getValueAt(r, 0));
        System.out.println(model.getValueAt(r, 1));
